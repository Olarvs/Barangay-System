          ...
          <header class="mb-4 lg:mb-6 not-format">
              <address class="flex items-center mb-6 not-italic">
                  <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                      ...
                      <div>
                          <a href="#" rel="author" class="text-xl font-bold text-gray-900 dark:text-white">Juan Dela Cruz</a>
                          <p class="text-base font-light text-gray-500 dark:text-gray-400">President, Palazzo Bello Association</p>
              ...
              <h1 class="mb-4 text-3xl font-extrabold leading-tight text-gray-900 lg:mb-6 lg:text-4xl dark:text-white">Welcome to the Palazzo Bello Community!</h1>
          </header>
          <p class="lead">Our web system is designed to provide information and services to the residents of Palazzo Bello, a private subdivision located in Carsadang Bago II, Imus City, Cavite.</p>
